...
function AboutUs() {
  ...
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Shubham's Plants, where green meets serenity!</p>
      <p className="about-us-content">
      At Shubham's Plants, we offer a wide variety of healthy plants, lush, from resilient succulents and delicate orchids to robust trees and vibrant flowering plants, each carefully selected to thrive in your specific environment. Our user-friendly website provides detailed care instructions, gardening tips, and expert advice to ensure your plants flourish. Whether you're an experienced gardener or just starting your green journey, Shubham's Plants is your trusted partner in cultivating a verdant and thriving oasis. Join our community of plant enthusiasts and let Shubham's Plants help you grow a greener world.
      </p>
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Shubham's Plants today and experience the 
